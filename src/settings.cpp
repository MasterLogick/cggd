...
std::shared_ptr<settings> cg::settings::parse_settings(int argc, char** argv)
{
	...
	add_options("camera_position", "Camera position", cxxopts::value<std::vector<float>>()->default_value("-3.0,1.0,3.0"));
	add_options("camera_theta", "Camera polar angle", cxxopts::value<float>()->default_value("30.0"));
